...
async function getFolder01(current_dicipline) {
  ...
  <div class="subheader-background" id="background">
    <div class="subheader-txt">
      <h1>${capitalize(current_dicipline)}</h1>
    </div>
  </div>
  <h2 class="description">Se desarrollaron formularios específicos para los procedimientos más frecuentes realizadas en el servicio de ${current_dicipline} de la Clínica Pasteur. <br>Recuerde que deben ser impresos, completados con los datos correspondientes, firmados por el paciente y validados con firma y sello del profesional médico interviniente.</h2>
...
document.addEventListener("click", function(e){
    if (e.target.dataset.especialidad) {
        ...
        getFolder01(current_especialidad)
    }
})
